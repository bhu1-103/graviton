...
while True:
    ...
    if ret:
        ...
        # Print the lane numbers where enemies exist
        if red_car_lane:
            print("Enemy detected in lane(s):", red_car_lane)
        if blue_car_lane:
            print("Enemy detected in lane(s):", blue_car_lane)
        if yellow_car_lane:
            print("Enemy detected in lane(s):", yellow_car_lane)

        # Determine safe lanes to go
        safe_lanes = set(lanes.keys()) - set(red_car_lane + blue_car_lane + yellow_car_lane)
        print("Safe lanes to go:", sorted(safe_lanes))
