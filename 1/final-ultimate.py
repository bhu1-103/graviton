...
while True:
    ...
    if ret:
        ...
        safe_lanes = [lane for lane in safe_lanes if lane in lanes]  # Filter out lanes outside the range
                ...
                if len(safe_lanes) == 2:
                    ...
                    for safe_lane in safe_lanes:
                        ...
                        if direction:
                            ...
                            if (red_car_lane[0] == 0 and direction == "right") or (red_car_lane[0] == 3 and direction == "left"):
